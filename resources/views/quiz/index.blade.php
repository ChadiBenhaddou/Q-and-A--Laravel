...
@section('content')
<div class="container">
    <div class="row"><div class="col-sm-12 d-flex justify-content-center "><h2 class="mt-4 font-weight-bold">Quiz</h2></div></div>
    <form action="" method="POST">
        ...
        @foreach (Session::get('ques') as $question)
            <div class="col-sm-4 mt-5 ">
               ...
               <input type="text" name="{{$question['question']}}" placeholder="Votre Reponse ici">   
            </div> 
        @endforeach
        <br><br>
